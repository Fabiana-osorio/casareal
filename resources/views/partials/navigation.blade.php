<div class="navbar bg-purple-300">
   ...
   4.5l5.25 5.25" />
    ...
    <a href="{{route('inicio')}}" class="btn btn-ghost btn-sm normal-case text-sm">CASA REAL</a>
    </div>
    <div class="flex-none">
    @auth
    ...
    <img src="https://images.unsplash.com/photo-1622164187693-91da7b2cbb44?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" />
    </div>
    </label>
